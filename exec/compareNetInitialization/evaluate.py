...
def main():
    ...
    independentVariables['initialization'] = ['uniform', 'normal',
                                              'glorot', 'he']
    independentVariables['structure'] = nnStructures
