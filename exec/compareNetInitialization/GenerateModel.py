...
class UniformInitializationModel:
    ...
    def __call__(self, sharedWidths, actionLayerWidths, valueLayerWidths, summaryPath="./tbdata"):
        ...
        with graph.as_default():
            ...
            initWeight = tf.random_uniform_initializer(-0.03, 0.03) # TODO: change initialize
...
class NomralInitializationModel:
    def __init__(self, numStateSpace, numActionSpace, regularizationFactor=0, valueRelativeErrBound=0.01, seed=128):
        self.numStateSpace = numStateSpace
        self.numActionSpace = numActionSpace
        self.regularizationFactor = regularizationFactor
    ...
    def __call__(self, sharedWidths, actionLayerWidths, valueLayerWidths, summaryPath="./tbdata"):
        ...
        with graph.as_default():
            ...
            initWeight = tf.random_normal_initializer(mean=0.0, stddev=1.0) # TODO: change initialize
            initBias = tf.constant_initializer(0.001)
...
class GlorotNormalInitializationModel:
    def __init__(self, numStateSpace, numActionSpace, regularizationFactor=0, valueRelativeErrBound=0.01, seed=128):
        self.numStateSpace = numStateSpace
        self.numActionSpace = numActionSpace
        self.regularizationFactor = regularizationFactor
    ...
    def __call__(self, sharedWidths, actionLayerWidths, valueLayerWidths, summaryPath="./tbdata"):
        ...
        with graph.as_default():
            ...
            initWeight = tf.glorot_normal_initializer() # TODO: change initialize
            initBias = tf.constant_initializer(0.001)
...
class HeNormalInitializationModel:
    def __init__(self, numStateSpace, numActionSpace, regularizationFactor=0, valueRelativeErrBound=0.01, seed=128):
        self.numStateSpace = numStateSpace
        self.numActionSpace = numActionSpace
        self.regularizationFactor = regularizationFactor
    ...
    def __call__(self, sharedWidths, actionLayerWidths, valueLayerWidths, summaryPath="./tbdata"):
        ...
        with graph.as_default():
            ...
            initWeight = tf.initializers.he_normal() # TODO: change initialize
            initBias = tf.constant_initializer(0.001)
