...
class GenerateSymmetricState:
    ...
    def __init__(self, numOfAgent, stateDim, qPosInex, xPosIndex, velIndex,
                 createSymmetricVector, calibrateState):
        self.numOfAgent = numOfAgent
        self.stateDim = stateDim
        self.qPosIndex = qPosInex
    ...
    def __call__(self, state, symmetry):
        ...
        for state in groupedState:
            state[self.qPosIndex] = np.round(createSymmetricVector(symmetry, state[self.qPosIndex]), 10)
