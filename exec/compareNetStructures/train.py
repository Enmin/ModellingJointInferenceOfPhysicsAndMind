...
from neuralNetwork.policyValueNet import GenerateModel, TrainWithCustomizedFetches, sampleData
...
def main(nnStructure):
    ...
    NNFixedParameters = {'regularization': regularizationFactor, 'structure': nnStructure, 'lossCoefs': lossCoefs,
...
if __name__ == '__main__':
    ...
    for nnStructure in nnStructures:
        main(nnStructure)
